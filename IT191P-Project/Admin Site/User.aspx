    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:DropDownList CssClass="form-control" ID="ddlSearchType" runat="server" placeholder="Search by:">
                 ...
                 <asp:ListItem Value="3">Account Type</asp:ListItem>
            ...
            <div class="col-lg-12">
                ...
                <asp:SqlDataSource ID="SqlDataSourceUser" runat="server" ConnectionString="<%$ ConnectionStrings:ZoomDB %>" SelectCommand="SELECT [ID], [LNAME], [FNAME], [MNAME], [EMAIL_ADD], [MOBILE_NO], [SEX], [USERTYPE] FROM [USER]"></asp:SqlDataSource>
