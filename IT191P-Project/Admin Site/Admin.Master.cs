    ...
    public partial class Admin : System.Web.UI.MasterPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //Hide some capabilities from the customers
                if (u.Type == "Customer")
                {
                    HideFromCustomers();
                }
        ...
        void HideFromCustomers()
        {
            //Branch
            createBranch.Attributes["style"] = "display:none;";
            editBranch.Attributes["style"] = "display:none;";

            //Users
            createUser.Attributes["style"] = "display:none;";
            editUser.Attributes["style"] = "display:none;";

            //Income
            Income.Attributes["style"] = "display:none;";
        }
